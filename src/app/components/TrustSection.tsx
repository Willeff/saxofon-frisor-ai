          ...
          <div className={`flex items-center gap-6 anim-fade-in-up stagger-1 ${socialInView ? "in-view" : ""}`}>
            ...
            <a href="https://www.instagram.com/saxofonfrisoer?igsh=eG1uNndzazUydGF5" target="_blank" rel="noopener noreferrer" aria-label="Instagram" className="social-hover">
              <svg className="w-7 h-7" viewBox="0 0 24 24" fill="none">
                ...
                <rect x="4.5" y="4.5" width="15" height="15" rx="4" stroke="#fff" strokeWidth="1.5" fill="none" />
            ...
            <a href="https://www.tiktok.com/@saxfoon" target="_blank" rel="noopener noreferrer" aria-label="TikTok" className="social-hover">
              <svg className="w-7 h-7" viewBox="0 0 24 24" fill="none">
                ...
                <path d="M16.5 5.5c.1 1.4 1.2 2.5 2.6 2.6v1.6c-1-.1-1.9-.5-2.6-1.1" stroke="#25F4EE" strokeWidth="0.3" fill="none" />
            ...
            <a href="https://g.page/saxofonfrisor" target="_blank" rel="noopener noreferrer" aria-label="Google" className="social-hover">
              <svg className="w-7 h-7" viewBox="0 0 24 24" fill="none">
                ...
                <path d="M12 19.5c1.93 0 3.54-.64 4.72-1.73l-2.3-1.79c-.64.43-1.46.68-2.42.68-1.86 0-3.43-1.26-3.99-2.94H5.63v1.85A7.13 7.13 0 0012 19.5z" fill="#34A853" />
                <path d="M8.01 13.72A4.28 4.28 0 017.78 12c0-.6.1-.93.23-1.36V8.79H5.63A7.13 7.13 0 004.87 12c0 1.15.28 2.24.76 3.21l2.38-1.49z" fill="#FBBC05" />
                <path d="M12 7.7c1.05 0 1.99.36 2.73 1.07l2.05-2.05A7.06 7.06 0 0012 4.5a7.13 7.13 0 00-6.37 3.93l2.38 1.85C8.57 8.96 10.14 7.7 12 7.7z" fill="#EA4335" />
              </svg>
            </a>
          </div>
        </div>
