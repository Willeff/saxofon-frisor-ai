...
export default function ContactPreview() {
  ...
  return (
    <section className="relative bg-[#171715] text-white py-14 md:py-20 px-6 overflow-hidden">
      <div
        aria-hidden
      ...
      <div className="relative max-w-5xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 gap-10 md:gap-16 items-center">
          ...
          <div>
            ...
            <h2 className="text-[clamp(1.6rem,3.5vw,2.6rem)] font-light tracking-wide leading-[1.2] mb-4 whitespace-pre-line">
              {c.heading}
            </h2>
            <p className="text-[15px] text-white/85 font-normal leading-[1.8] mb-6 max-w-md">
              {c.body}
            </p>
            ...
            <div className="flex flex-col sm:flex-row gap-3 mb-6">
              <a
                ...
                className="text-center px-8 py-3.5 bg-[#C4A882] text-[#0F0F0F] text-[12px] tracking-[0.18em] uppercase font-medium hover:bg-white transition-colors"
              >
                {c.book}
              </a>
              <Link
                href="/kontakt"
                className="text-center px-8 py-3.5 border border-white/20 text-white/75 text-[12px] tracking-[0.18em] uppercase hover:border-white/40 hover:text-white transition-all"
              >
                {t.preview.contactUs}
              </Link>
            </div>
          ...
          <div className="flex flex-col gap-5">
            <a href="tel:+4745555898" className="flex items-center gap-4 group">
              <div className="w-10 h-10 border border-white/[0.1] flex items-center justify-center flex-none">
